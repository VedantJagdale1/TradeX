...
* **News on What You Hold:** Recent coverage on each stock's detail screen and a combined stream for your holdings on the dashboard — newest first, de-duplicated, with price-prediction pieces filtered out. Deliberately not a market-wide feed: it explains moves in positions you have, rather than prompting new trades.
